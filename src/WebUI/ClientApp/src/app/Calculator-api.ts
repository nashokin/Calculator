...
export interface ICalculatorClient {
    calculate(command: CalculatorCommand): Observable<CalculatorResult>;
}

@Injectable({
    providedIn: 'root'
})
export class CalculatorClient implements ICalculatorClient {
    ...
    calculate(command: CalculatorCommand): Observable<CalculatorResult> {
        let url_ = this.baseUrl + "/api/Calculator";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CalculatorResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<CalculatorResult>><any>_observableThrow(response_);
        }));
    }

    protected processCalculate(response: HttpResponseBase): Observable<CalculatorResult> {
        ...
        if (status === 200) {
            ...
            result200 = CalculatorResult.fromJS(resultData200);
        ...
        return _observableOf<CalculatorResult>(<any>null);
    }
}
...
export class CalculatorResult extends AuditableEntity implements ICalculatorResult {
    id?: number;
    num1?: number;
    ...
    constructor(data?: ICalculatorResult) {
        super(data);
    }
    ...
    static fromJS(data: any): CalculatorResult {
        data = typeof data === 'object' ? data : {};
        let result = new CalculatorResult();
        result.init(data);
        return result;
    }
...
export interface ICalculatorResult extends IAuditableEntity {
    id?: number;
    num1?: number;
    action?: CalculatorAction;
    num2?: number;
...
export class CalculatorCommand implements ICalculatorCommand {
    num1?: number;
    action?: CalculatorAction;
    num2?: number;

    constructor(data?: ICalculatorCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CalculatorCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CalculatorCommand();
        result.init(data);
        return result;
    }
